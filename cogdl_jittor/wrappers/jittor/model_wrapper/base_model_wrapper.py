...
import jittor
from ..tools.wrapper_utils import merge_batch_indexes
from cogdl_jittor.utils.jittor.evaluator import setup_evaluator, Accuracy, MultiLabelMicroF1


class ModelWrapper(jittor.Module):
    @staticmethod
    def add_args(parser):
        pass
    ...
    def evaluate(self, pred: jittor.Var, labels: jittor.Var, metric: Union[str, Callable] = "auto"):
        """
