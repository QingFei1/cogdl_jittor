...
from cogdl_jittor.wrappers.jittor.model_wrapper.base_model_wrapper import ModelWrapper, EmbeddingModelWrapper
...
from cogdl_jittor.loggers import build_logger
