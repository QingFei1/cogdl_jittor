...
from cogdl_jittor.utils import remove_self_loops, download_url, untar, coalesce, Accuracy, CrossEntropyLoss
...
def read_planetoid_data(folder, prefix):
    ...
    test_index = BF.tensor(test_index, dtype=BF.dtype_dict("long"))
