...
import jittor
from cogdl_jittor.data import Adjacency, Graph
from cogdl_jittor.utils import makedirs
from cogdl_jittor.utils import Accuracy, CrossEntropyLoss
from cogdl_jittor.data import Batch
def to_list(x):
...
class MultiGraphDataset(jittor.dataset.Dataset):
