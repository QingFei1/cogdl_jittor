...
from cogdl_jittor.layers import SELayer, GATLayer
...
if __name__ == "__main__":
    dataset = CoraDataset()
    model = DrGAT(num_features=dataset.num_features, hidden_size=8, num_classes=dataset.num_classes,num_heads=8,dropout=0.5)
