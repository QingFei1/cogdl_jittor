...
jittor.flags.use_device=1

from cogdl_jittor.models import BaseModel
from cogdl_jittor.models.nn.dgi import GCN
from cogdl_jittor.utils.ppr_utils import build_topk_ppr_matrix_from_data
...
if __name__ == "__main__":
    # data = generate_random_graph(num_nodes=10, num_edges=30, num_feats=30)
    # dataset = NodeDataset(data=data)
    dataset=CoraDataset()
    model = MVGRL(in_feats=dataset.num_features, hidden_size=512)
